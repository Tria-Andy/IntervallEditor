...
void standardWorkouts::read_standard_workouts()
{
    ...
    QFile metaWork(QApplication::applicationDirPath() + QDir::separator() +"standard_workouts_meta.xml");
    ...
    QFile stepWork(QApplication::applicationDirPath() + QDir::separator() +"standard_workouts_steps.xml");
...
void standardWorkouts::write_standard_workouts()
{
    if (save_workouts)
    {
        ...
        QFile metaFile(QApplication::applicationDirPath() + QDir::separator() +"standard_workouts_meta.xml");
        ...
        QFile stepFile(QApplication::applicationDirPath() + QDir::separator() +"standard_workouts_steps.xml");
